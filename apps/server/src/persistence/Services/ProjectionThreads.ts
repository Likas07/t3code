...
export const ProjectionThread = Schema.Struct({
  ...
  forkKind: Schema.NullOr(Schema.Literal("semantic")),
  forkSourceThreadId: Schema.NullOr(ThreadId),
  forkBootstrapStatus: Schema.NullOr(Schema.Literals(["pending", "completed"])),
  forkImportedMessageCount: Schema.NullOr(NonNegativeInt),
  forkCreatedAt: Schema.NullOr(IsoDateTime),
  forkBootstrappedAt: Schema.NullOr(IsoDateTime),
  rootThreadId: ThreadId,
  parentThreadId: Schema.NullOr(ThreadId),
  delegationDepth: NonNegativeInt,
  delegationRole: Schema.Literals(["primary", "child"]),
  parentBatchId: Schema.NullOr(Schema.String),
